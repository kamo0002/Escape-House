...
var Game = (function () {
    ...
    Game.prototype.createRooms = function () {
        ...
        var kelder = new Room("in de kelder. Hier is geen uitgang.");
        ...
        var zwartegat = new Room("in het zwarte gat gesprongen en het was een val. Game Over!!!");
        ...
        var kabelbaanvoorkantdakonder = new Room("gesprongen en hebt de goede keus gemaakt. Je bent vrij gefeliciteerd je hebt gewonnen!!!");
        ...
        var kabelbaanachterkantdakonder = new Room("dood de kabel is afgebroken hij was niet stevig genoeg. Game over!!!");
